#!/usr/bin/env bash
# Initialize a fresh FLIGHTBOT_DATA_DIR on a new host (e.g. AWS EC2 + Docker volume).
...
echo "Set FLIGHTBOT_DATA_DIR=${DATA_DIR} (or mount this path as /data in Docker)."
